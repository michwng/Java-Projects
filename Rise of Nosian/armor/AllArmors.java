...
//This class has been copied over from a previous project.
...
public class AllArmors extends Armor
{
	...
	public AllArmors() 
	{
		...
		Armor helmet = new Armor(BodyPart.Head, "Trainee's Cap", "A lightweight cap that allows visibility.", "Lightweight - Easy to Move!.", 5, 0, 0, 1);
