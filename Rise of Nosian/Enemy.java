...
public class Enemy
{
    ...
    private ArrayList<Skill> originalSkills = new ArrayList<>();
    ...
    public Enemy(int area)
    {
        ...
        if (randomNum == 1) {
            ...
            skill1 = new Skill("Fierce Slash", "Slash the target with a blade. Deals physical damage equal to (Enemy Constitution * 1.2)", (int)(enemyConstitution * 1.2), "Enemy");
            skill2 = new Skill("Decimate", "Weaken", 20, 2, 5, (int)(enemyConstitution * 0.9), "Deals physical damage equal to (Enemy Constitution * 0.9)", "(20% PROC) Weaken the target for 5 Constitution for 2 turns.", "Enemy", "Enemy", "Constant");
        }
        if (randomNum == 2) {
            enemyClass = "Mage";
            enemyName = "Vampire";
            ...
            skill1 = new Skill("Enigma", "Deal magical damage equal to (Enemy Affinity * 1.2).", (int)(enemyAffinity * 1.2), "Enemy");
            skill2 = new Skill("Succ", "Drain", 70, 0, 0, (int)(enemyAffinity * 0.7), "Deal magical damage equal to (Enemy Affinity * 0.7).", "Heal the user for 70% of the damage done.", "Enemy", "Enemy", "Constant");
        }
        if (randomNum == 3) {
            enemyClass = "Warrior";
            enemyName = "Goblin";
            ...
            skill1 = new Skill("Simple Slash", "Deal physical damage equal to Enemy Constitution.", enemyConstitution, "Enemy");
            skill2 = new Skill("Cripple", "Cripple", 30, 0, 0, (int) (enemyConstitution * 0.8), "Deal physical damage equal to (Enemy Constitution * 0.8).", "(30% PROC) Cripple the target.", "Enemy", "Enemy", "Constant");
        }
        //TODO Uncomment
        /*
        if (randomNum == 4) {
        ...
        */
        ...
        //add both skills to the enemySkills array.
        enemySkills.add(skill1);
        enemySkills.add(skill2);

        //Set original skills equal to enemySkills.
        //originalSkills keeps the original skill's stats, in case a status effect is inflicted on the enemy.
        //(enemySkills is subject to damage change.)
        ...
        if(!customMusic)
        {
            ...
            switch(randomNum)
            {
                case 1:
                    try
                    {
                        WP = new WavePlayer("5.RegularBattle1-Sonny2Music-InternalConflict.wav", true);
                    }
                ...
                case 2:
                    try
                    {
                        WP = new WavePlayer("6.RegularBattle2-Sonny2Music-Outnumbered.wav", true);
                    }
                    catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
                    {
                        e.printStackTrace();
                ...
                case 3:
                    try
                    {
                        WP = new WavePlayer("7.RegularBattle3-Sonny2Music-CalltoArms.wav", true);
                    }
                    catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
                    {
                        e.printStackTrace();
        ...
        else
        {
            try
            {
                WP = new WavePlayer("11.BattleSecretEnemy-THEWORLDREVOLVING.wav", true);
            }
            catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
            {
                e.printStackTrace();
    ...
    public Enemy(String enemy, int area)
    {
        ...
        if(enemy.equals("Anthiera"))
        {
            try
            {
                WP = new WavePlayer("8.BattleAnthiera-PokemonORAS-BattleLorekeeperZinnia.wav", true);
            }
            catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
            {
                e.printStackTrace();
            ...
            if(true)
            {
                ...
                skill1 = new Skill("Simple Slash", "Deal physical damage equal to Enemy Constitution.", enemyConstitution, "Enemy");
                skill2 = new Skill("Cripple", "Cripple", 30, 0, 0, (int) (enemyConstitution * 0.8), "Deal physical damage equal to (Enemy Constitution * 0.8).", "(30% PROC) Cripple the target.", "Enemy", "Enemy", "Constant");
                skill3 = new Skill("Cripple", "Cripple", 30, 0, 0, (int) (enemyConstitution * 0.8), "Deal physical damage equal to (Enemy Constitution * 0.8).", "(30% PROC) Cripple the target.", "Enemy", "Enemy", "Constant");
        ...
        if(enemy.equals("Cyronian Warrior"))
        {
            try
            {
                WP = new WavePlayer("Soundtrack\\Heroic Confrontation.wav", true);
            }
            catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
            {
                e.printStackTrace();
            ...
            enemyClass = "Warrior";
            enemyName = "Cyronian Warrior";
            enemyDescription = "A scary man in iron armor, with an iron sword!";
            enemyHP = 30;
            enemyMaxHP = enemyHP;
            enemyConstitution = 45;
            enemyAffinity = 0;
            enemySpeed = 15;
            enemyXPAward = 50;
            enemyMoneyAward = 180;
            ...
            skill1 = new Skill("Slice", "Cleave your sword at the target. Deals damage equal to 150% of Constitution.", (int)(enemyConstitution * 1.5), "Enemy");
            skill2 = new Skill("Stab", "Bleed", 50, 4, 10, enemyConstitution, "Attempt to drive a sword through the target. Deal physical damage equal to Constitution.", "(50% PROC) Bleed the target for 10HP every turn for 4 turns.", "Enemy", "Enemy", "Constant");
        }
        if(enemy.equals("Practice Dummy"))
        {
            try
            {
                WP = new WavePlayer("2.TheFirstFight-FireEmblemPathofRadiance.wav", true);
            }
            catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
            {
                e.printStackTrace();
            ...
            enemyDescription = "A practice dummy with signs of wear and use.";
            enemyHP = 150;
            enemyMaxHP = enemyHP;
            enemyConstitution = 5;
            enemyAffinity = 0;
            ...
            skill1 = new Skill("Newton's 3rd Law of Motion", "You swung at the dummy, and knocked it back. But, it's coming back for revenge!", enemyConstitution * 2, "Enemy");
            skill2 = new Skill("Punch", "You swing at the dummy's arms, which made the dummy spin, clocking you with his other arm.", enemyConstitution, "Enemy");
        }
        ...
        if(enemy.equals("Legion Royal Guard"))
        {
            try
            {
                WP = new WavePlayer("9.BattleBoss-PokemonSwordShield-BattleGymLeader-Rematch.wav", true);
            }
            catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
            {
                e.printStackTrace();
        ...
        if(enemy.equals("Leader of the Legion"))
        {
            try
            {
                WP = new WavePlayer("10.BattleLeaderoftheLegion-FireEmblem3Houses-TheApexoftheWorldRain.wav", true);
            }
            catch (UnsupportedAudioFileException | IOException | LineUnavailableException e)
            {
                e.printStackTrace();
        ...
        enemySkills.add(skill1);
        enemySkills.add(skill2);
        //enemySkills.add(skill3);

        originalSkills = new ArrayList<>();
        originalSkills.add(skill1);
        originalSkills.add(skill2);
        //originalSkills.add(skill3);
    }
    /**
    ...
    public Enemy(Ally ally)
    {
        try
        {
            if(ally.getName().equals("Zacharias"))
            {
                WP = new WavePlayer("3.BattleZacharias-PokemonBlackandWhite2-BattleRival.wav", true);
            }
            else
            {
                WP = new WavePlayer("8.BattleAnthiera-PokemonORAS-BattleLorekeeperZinnia.wav", true);
        ...
        enemyClass = ally.getSpecialization();
        enemyName = ally.getName();
        enemyDescription = ally.getDescription();
        enemyHP = ally.getHP();
        enemyMaxHP = enemyHP;
        ...
        enemySkills = ally.getAllySkillsArrayList();
    }
    /**
    ...
    {
        //The StatusEffect object has already taken away the enemy's stat.
        //We calculate the stat change here and change skill damage based on the theoretical change.
        int theoreticalConstitution = enemyConstitution + efficacy;
        int theoreticalAffinity = enemyAffinity + efficacy; 
        ...
        if(enemyClass.equals("Mage") || enemyClass.equals("Sage"))
        {
            ...
            {
                //Reduces skill damage based on efficacy.
                for(Skill skill: enemySkills)
                {
                    //Skills normally use the Affinity stat times a multiplier. This statement gets that multiplier.
                    ratio = (skill.getDamage() * 1.0) / (theoreticalAffinity * 1.0);
                    //This is neccessary to make sure we can accurately convert skill damages to the correct value. 

                    //Debug Variables. Comment out. 
                    /*
                    System.out.println(skill.getDamage() + "/" + theoreticalAffinity);
                    System.out.println("Ratio: " + ratio);
                    System.out.println("New DMG: " + skill.getDamage());*/

                    skill.setDamage((int)(enemyAffinity * ratio));
                }
            }
        ...
        else
        {
            ...
            if(statusEffect.equals("Weakened"))
            {
                ...
                for(Skill skill: enemySkills)
                {
                    //Skills normally use the Constitution stat times a multiplier. This statement gets that multiplier.
                    //This is neccessary to make sure we can accurately convert skill damages to the correct value after stat change. 
                    ratio = (skill.getDamage() * 1.0) / (theoreticalConstitution * 1.0);

                    //Debug Variables. Comment out.
                    /*
                    System.out.println(skill.getDamage() + "/" + theoreticalConstitution);
                    System.out.println("Ratio: " + ratio);
                    System.out.println("New DMG: " + skill.getDamage());*/

                    skill.setDamage((int)(enemyConstitution * ratio));
                }
            }
    ...
    public String getEnemyInformation()
    {
        ...
        for(int i = 0; i < enemySkills.size(); i++)
        {
            ...
            message += "\n===============\nSkill " + (i+1) + ": " + enemySkills.get(i).toString() + "===============\n";
        }
        return message;
    }
    ...
    {
        return enemySkills.size();
    }

    /**
     * Return a skill at the specified index from the enemySkills array.
     * 
     * @param index
     * @return Skill
     */
    ...
    private void balanceDifficulty()
    {
        ...
        if(Driver.getDifficulty().equals("Medium"))
        {
        ...
        else if(Driver.getDifficulty().equals("Hard"))
        {
    ...
    {
        if(Driver.getXPMultiplier() == 2)
        {
            enemyXPAward *= 2;
        }
        else if(Driver.getXPMultiplier() == 3)
        {
            enemyXPAward *= 3;
        }
    }
