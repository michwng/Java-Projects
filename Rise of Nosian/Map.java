...
public class Map {
     ...
     * 
     * Statistics nosian is needed to have access to the hero's attributes.
     ...
     * @param heroName     - String
     */
    public Map(Hero nosian, Ally currentAlly, Ally currentAlly2, int area) {
        events.add("Potion");
        events.add("Poison Potion");
        events.add("Enemy Encounter");
        events.add("Experience Encounter");
        ...
        this.nosian = nosian;
        this.currentAlly = currentAlly;
        this.currentAlly2 = currentAlly2;
        this.area = area;
        checkLocation();
    }
    ...
    private void advanceScenario(String scenario)
    {
        ...
        if (scenario.equals("Boss Battle"))
        {
            ...
            Driver.stopMusic();
            if (area == 10) {
                JOptionPane.showMessageDialog(null, "Upon advancing the 10th floor, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " encounter a large knight encased in armor. \nThey appear to be guarding the entrance to the next area.", "Pre-Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                ...
                //int optionChosen = JOptionPane.showOptionDialog(null, "\"Looks like we'll have to fight this guy in order to get through,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                String[] options = {"YES"};
                JOptionPane.showOptionDialog(null, "\"Looks like we'll have to fight this guy in order to get through,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);

                //if(optionChosen == 0)
                //{
                    JOptionPane.showMessageDialog(null, "\"Alright,\" " + currentAlly.getName() + " says. \n\"Here goes nothing.\"", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    JOptionPane.showMessageDialog(null, "You and " + currentAlly.getName() + " ambush the Knight and begin battle.", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy knight = new Enemy("Legion Royal Guard", getArea());
                    bat = new Battle(nosian, currentAlly, knight);
                    //If the hero loses.
                    if(!bat.getResult())
                    {
                        area--;
                ...
                //    JOptionPane.showMessageDialog(null, "\"Perhaps a little more preparation can help our chances,\" " + currentAlly.getName() + " says.", "Flee", JOptionPane.INFORMATION_MESSAGE);
                //    area--;
                //}
        ...
        {
                JOptionPane.showMessageDialog(null, "Upon advancing the 20th floor, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " encounter a strong cavalier. \nThey appear to be a cavalier leader, judging by their insignia.", "Pre-Boss Battle", JOptionPane.INFORMATION_MESSAGE);

                //The original options allows the user to choose whether or not to fight the boss.
                //Options that allow the user to decide have been commented out.
                //String[] options = {"YES", "NO!"};
                //int optionChosen = JOptionPane.showOptionDialog(null, "\"Fighting this guy will demoralize their troops and improve out chances here,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                String[] options = {"YES"};
                JOptionPane.showOptionDialog(null, "\"Fighting this guy will demoralize their troops and improve out chances here,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                
                //if(optionChosen == 0)
                //{
                    JOptionPane.showMessageDialog(null, "\"Alright,\" " + currentAlly.getName() + " says. \n\"Here we go!\"", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    JOptionPane.showMessageDialog(null, "You and " + currentAlly.getName() + " ambush the Cavalier and begin battle.", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy bowmen = new Enemy("Cavalry Squad Leader", getArea());
                    bat = new Battle(nosian, currentAlly, bowmen);
                    //If the hero loses.
                    if(!bat.getResult())
                    {
                        area--;
            ...
            {
                JOptionPane.showMessageDialog(null, "Upon advancing the 30th floor, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " encounter a menacing skeleton with a scythe, guarding the entrance of a portal.", "Pre-Boss Battle", JOptionPane.INFORMATION_MESSAGE);

                //The original options allows the user to choose whether or not to fight the boss.
                //Options that allow the user to decide have been commented out.
                //String[] options = {"YES", "NO!"};
                String[] options = {"YES"};
                //int optionChosen = JOptionPane.showOptionDialog(null, "\"We will have to fight this skeleton in order to pass through,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                JOptionPane.showOptionDialog(null, "\"We will have to fight this skeleton in order to pass through,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);

                // if(optionChosen == 0)
                // {
                    JOptionPane.showMessageDialog(null, "\"Alright,\" " + currentAlly.getName() + " says. \n\"Let's go!\"", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    JOptionPane.showMessageDialog(null, "You and " + currentAlly.getName() + " ambush the Skeleton and begin battle.", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy reaper = new Enemy("Reaper", getArea());
                    bat = new Battle(nosian, currentAlly, reaper);
                    //If the hero loses.
                    if(!bat.getResult())
                    {
                        area--;
            ...
            {
                JOptionPane.showMessageDialog(null, "Upon advancing the 40th floor, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " are suddenly ambushed by several shadows.", "Pre-Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                ...
                String[] options = {"YES"};
                //int optionChosen = JOptionPane.showOptionDialog(null, "\"Looks like this guy won't let us through without a fight,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                JOptionPane.showOptionDialog(null, "\"Looks like this guy won't let us through without a fight,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                //if(optionChosen == 0)
                //{
                    JOptionPane.showMessageDialog(null, "\"Alright,\" " + currentAlly.getName() + " says. \n\"Let's go!\"", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    JOptionPane.showMessageDialog(null, "You and " + currentAlly.getName() + " attack the Shadow and begin battle.", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy shadow = new Enemy("Shadow Ruler", getArea());
                    bat = new Battle(nosian, currentAlly, shadow);
                    //If the hero loses.
                    if(!bat.getResult())
                    {
                        area--;
                ...
                //else
                //{
                //JOptionPane.showMessageDialog(null, "You decided not to engage the Shadow and flee alongside " + currentAlly.getName() + ".", "Flee", JOptionPane.INFORMATION_MESSAGE);
                //JOptionPane.showMessageDialog(null, "\"Perhaps a little more preparation can help our chances,\" " + currentAlly.getName() + " says.", "Flee", JOptionPane.INFORMATION_MESSAGE);
                //area--;
                //}
            }
            ...
            {
                JOptionPane.showMessageDialog(null, "Upon advancing the 50th floor, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " are stopped by a magical barrier.", "Pre-Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                ...
                //String[] options = {"YES", "FLEE!"};
                String[] options = {"YES"};
                //int optionChosen = JOptionPane.showOptionDialog(null, "\"I will never submit to the Monster Legion.\"\n" + currentAlly.getName() + " Looks at you with determination. This guy won't let us through without a fight,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                JOptionPane.showOptionDialog(null, currentAlly.getName() + " looks at you with determination. \n\"This guy won't let us through without a fight,\" " + currentAlly.getName() + " says. \n\"Are you ready?\"", "Pre-Boss Battle", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);

                //if(optionChosen == 0)
                //{
                    JOptionPane.showMessageDialog(null, "\"Of Course,\" " + currentAlly.getName() + " says. \n\"Let's go!\"", "Initiated Boss Battle", JOptionPane.INFORMATION_MESSAGE);
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy robertz = new Enemy("Robertz", getArea());
                    bat = new Battle(nosian, currentAlly, robertz);
                    //If the hero loses.
                    if(!bat.getResult())
                    {
                        area--;
                    }
                    else //The hero/currentAlly wins
                    {
                ...
                //else
                //{
                //JOptionPane.showMessageDialog(null, "You decided not to engage the Mage and flee alongside " + currentAlly.getName() + ".", "Flee", JOptionPane.INFORMATION_MESSAGE);
                //JOptionPane.showMessageDialog(null, "\"Perhaps a little more preparation can help our chances,\" " + currentAlly.getName() + " says.", "Flee", JOptionPane.INFORMATION_MESSAGE);
                //area--;
                //}
            }
            else if(area == 60)
            {
                ...
                try
                {
                    wPlayer = new WavePlayer("13.Hope-FireEmblemThreeHouses-AWorldforHumanity.wav", true);
                    ...
                    //{
                        ...
                        JOptionPane.showMessageDialog(null, nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " bust into the room.\n", "Before the Final Battle", JOptionPane.INFORMATION_MESSAGE);
                        ...
                        bat = new Battle(nosian, currentAlly, leaderLegion);
                        //If the hero loses.
                        if(!(bat.getResult()))
                        {
                            area--;
                            JOptionPane.showMessageDialog(null, "\"Looks like we were not prepared,\" " + currentAlly.getName() + " says. \n\"Let us do so before fighting him again\".", "Defeated", JOptionPane.INFORMATION_MESSAGE);
                        }
                        else
                        {
                            //Plays ending theme.
                            wPlayer = new WavePlayer("14.Ending-TheHeritorsofArcadia(Instrumental).wav", true);
                            ...
                            + "\n) Pokemon Omega Ruby & Alpha wPlayerphire (ORAS) - (Battle! (Lorekeeper Zinnia) [BattleAnthiera])"
                    ...
                    //else
                    //{
                    //    JOptionPane.showMessageDialog(null, "\"You're right,\" " + currentAlly.getName() + " says. \"It would be ill-advised to go in unprepared. Let us prepare some more.\"", "Flee", JOptionPane.INFORMATION_MESSAGE);
                    //    area--;
                    //}
                }
            ...
            else if(area == 70)
            {
                ...
                bat = new Battle(nosian, currentAlly, councilKnight);
                //If the hero loses.
                if(!bat.getResult())
                {
                    area--;
            ...
            else if(area == 80)
            {
                ...
                bat = new Battle(nosian, currentAlly, councilMember);
                //If the hero loses.
                if(!bat.getResult())
                {
                    area--;
            ...
            else if(area == 90)
            {
                ...
                bat = new Battle(nosian, currentAlly, councilCommander);
                //If the hero loses.
                if(!bat.getResult())
                {
                    area--;
            ...
            else if(area == 100)
            {
                ...
                bat = new Battle(nosian, currentAlly, darkGuardian);
                //If the hero loses.
                if(!bat.getResult())
                {
                    area--;
            ...
            else if(area >= 110)
            {
                ...
                bat = new Battle(nosian, currentAlly, darkness);
                //If the hero loses.
                if(!bat.getResult())
                {
                    area--;
        ...
        if(scenario.equals("Potion"))
        {
            ...
            JOptionPane.showMessageDialog(null, nosian.getName() + " found a Potion! They decided to drink it. \nThe Potion was good! Max HP has increased and HP is restored!\n", "Good Potion!", JOptionPane.INFORMATION_MESSAGE);
            System.out.println(nosian.getName() + " found a Potion! They decided to drink it.");
        ...
        if(scenario.equals("Random Event"))
        {
            ...
            if(randomNum == 1)
            {
                ...
                message += "While walking through the dungeon, " + nosian.getName() + " sees a man in a suit.";
                message += "\nHe notices you, and walks closer.\n";
                message += "\n\"Helo, Strngr.\", he says, \"My naem is Meme Man. Nis wether wi r havng tuday.\"";
                message += "\n" + nosian.getName() + " feels like they have heard this man before, but they do not recall.";
                message += "\n" + nosian.getName() + " had a long and thoughtful conversation with Meme Man.";
                message += "\n\nAffinity increased by 1!";

                JOptionPane.showMessageDialog(null, message, "Interaction", JOptionPane.INFORMATION_MESSAGE);
                nosian.addAffinity(1);
            }
            //All-Star Encounter
            if(randomNum == 2)
            {
                //Lyrics altered.
                String message = "";
                message += "While navigating the dungeon, " + nosian.getName() + " hears strange music. They decide to investigate.";
                message += "\nUpon further inspection, " + nosian.getName() + " sees a musician wearing black sunglasses.";
                message += "\n\"Years begin coming and they do not stop coming.\"";
                message += "\n\"You're an all-star, get your show on!\"";
                message += "\n" + nosian.getName() + " listened to the entirety of their performance. Invigorating!!";
                ...
                nosian.addConstitution(1);
                nosian.addResistance(2);
            }
            //Ultra-Instinct Shaggy Encounter
            if(randomNum == 3)
            {
                String message = "";
                message += "While walking through the dungeon, " + nosian.getName() + " notices a strange light emanating from a room.";
                message += "\nUpon further inspection, " + nosian.getName() + " sees a floating person in a green shirt with blue flames circling around their body.";
                ...
                message += "\n" + nosian.getName() + " decided to leave before either person notices him.";
            ...
            {
                String message = "";
                message += "While navigating the dungeon, " + nosian.getName() + " notices a person walking into a room.";
                message += "\n" + nosian.getName() + " hears the person saying \"Are you winning, son?\" inside the room";
                message += "\n" + nosian.getName() + " hears a reply from inside. \"Yes, Dad\"!";
                message += "\n" + nosian.getName() + " leaves with an emboldened sense of courage.";
                ...
                nosian.addConstitution(2);
                nosian.addAffinity(2);
            }
            //Financial Support Encounter
            if(randomNum == 5)
            {
                String message = "";
                message += "While navigating the dungeon, " + nosian.getName() + " hears a public speaker.";
                message += "\nlistening closely, the speaker appears to be speaking on the other side of a wall.";
                message += "\n" + nosian.getName() + " listens. They can hear \"I am asking once again for Financial Support.\"\n";
                message += "\n It appears they want $200 to fund their 'campaign'.\n\n";
                
                if(nosian.getMoney() >= 200)
                {
                    message += nosian.getName() + " notices a coin slot. They slip in some money and walk away.";
                ...
                {
                    message += nosian.getName() + " could not afford to give $200 of financial support.";
                    message += "\nAs " + nosian.getName() + " turns away, the wall suddenly breaks down, revealing a man wearing simple clothes, with socks, sandals, mittens, and white hair.";
                    message += "\n\"I... need my financial support...\" he says, drooling a puddle on the floor.";
                    message += "\nThe man lunges at" + nosian.getName() + ", who dodges the attack. It's safe to assume that this man wants to do harm.";
                    ...
                    Battle bat = new Battle(nosian, currentAlly, sandles);
                    bat.getResult();
                }
            }
        }
        if(scenario.equals("Experience Encounter"))
        {
            ...
            if(randomNum == 1)
            {
                JOptionPane.showMessageDialog(null, "While navigating the dungeon, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " walks up to an obstruction that blocks the way.\n"
                                                    + nosian.getName() + " looks around, but the obstruction appears to be the only way forward.\n" 
                                                    + nosian.getName() + " & " + currentAlly.getName() + " spend time clearing the obstruction, gaining XP as they continue.\n" 
                                                    + nosian.getName() + " & " + currentAlly.getName() + " gained 30XP!\n", "Cleared Obstruction", JOptionPane.INFORMATION_MESSAGE);
                System.out.println("While navigating the dungeon, " + nosian.getName() + " walks up to an obstruction that blocks the way.");
                System.out.println(nosian.getName() + " looks around, but the obstruction appears to be the only way forward.");
                System.out.println(nosian.getName() + " spends time clearing the obstruction, gaining XP as they continue.");
                System.out.println(nosian.getName() + " gained 30XP!");
                nosian.addExperience(30);
            }
            //Adventurer
            if(randomNum == 2)
            {
                JOptionPane.showMessageDialog(null, "While navigating the dungeon, " + nosian.getName() + " notices another adventurer and greet them.\n"
                                                    + nosian.getName() + " and the adventurer practice their skills with each other, to prepare for future battles.\n" 
                                                    + nosian.getName() + " & " + currentAlly.getName() + " wish the adventurer safe travels as they conclude their training session.\n"
                                                    + nosian.getName() + " gained 70XP!\n", "Practice with an Adventurer", JOptionPane.INFORMATION_MESSAGE);
                System.out.println("While navigating the dungeon, " + nosian.getName() + " notices another adventurer and greet them.");
                System.out.println(nosian.getName() + " and the adventurer practice their skills with each other, to prepare for future battles.");
                System.out.println(nosian.getName() + " wishes the adventurer safe travels as they conclude their training session.");
                System.out.println(nosian.getName() + " gained 70XP!");
                nosian.addExperience(70);
            }
            //Armory
            if(randomNum == 3)
            {
                JOptionPane.showMessageDialog(null, "While navigating the dungeon, " + nosian.getName() + " finds an armory.\n"
                                                    + nosian.getName() + " & " + currentAlly.getName() + " make use of the weapons and books laying around the armory to practice on training dummies.\n"
                                                    + nosian.getName() + " & " + currentAlly.getName() + " spend time practicing new techniques in the armory and leaves with more experience.\n"
                                                    + nosian.getName() + " & " + currentAlly.getName() + " gained 100XP!\n", "Armory Practice", JOptionPane.INFORMATION_MESSAGE);
                System.out.println("While navigating the dungeon, " + nosian.getName() + " finds an armory.\n");
                System.out.println(nosian.getName() + " makes use of the weapons and books laying around the armory to practice on training dummies.\n");
                System.out.println(nosian.getName() + " spends time practicing new techniques in the armory and leaves with more experience.\n");
                System.out.println(nosian.getName() + " gained 100XP!\n");
                nosian.addExperience(100);
            }
        }
        if(scenario.equals("Loose Money"))
        {
            JOptionPane.showMessageDialog(null, "Whilst adventuring, " + nosian.getName() + ", " + currentAlly.getName() + ", and " + currentAlly2.getName() +  " find loose change on the floor. \n\nYou got $150!", "Loose Change", JOptionPane.INFORMATION_MESSAGE);
            nosian.addMoney(150);
        }
        if(scenario.equals("Enemy Encounter"))
        {
            ...
            Driver.stopMusic();
            JOptionPane.showMessageDialog(null, "While " + nosian.getName() + " is navigating, he encounters an enemy. \nThe enemy lunges, and a Battle commences.", "Battle Commencement", JOptionPane.INFORMATION_MESSAGE);
            System.out.println("While " + nosian.getName() + " is navigating, he encounters an enemy.");
            System.out.println("The enemy lunges, and a Battle commences.");
            Battle bat = new Battle(nosian, currentAlly, getArea());
            if(!bat.getResult())
            {
                //Decrements area if a loss happens.
                area--;
            }
        ...
        if(scenario.equals("Encounter"))
        {
            ...
            Battle bat = new Battle(nosian, currentAlly, anthiera);
            ...
            else
            {
                ...
                JOptionPane.showOptionDialog(null, nosian.getName() + " and Zacharias back away from battle and withdraw their weapons.", "Encounter", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options5, options5[0]);
            ...
            JOptionPane.showOptionDialog(null, nosian.getName() + " and Zacharias nod. They all begin to traverse the dungeon together.", "Encounter", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options5, options5[0]);
     ...
     * @param currentAlly
     */
    public void setAlly(Ally currentAlly)
    {
        this.currentAlly = currentAlly;
    }
}
